...
<html>
<head>
    <title>Railway Pass Management System | View Pass Detail</title>
        ...
        <!-- end navbar side -->
         ...
         <div id="page-wrapper">
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">View Pass Detail</h1>
                </div>
                <!--End Page Header -->
            </div>
            <div class="row">
...
<p style="text-align:center; font-size:20px; color:red"><input type="button" value="Print" onclick="printDiv();"></p>
</div>
                            </div>
                        </div>
                    </div>
